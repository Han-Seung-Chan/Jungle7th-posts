<template>
  ...
  <div v-else>
    ...
    <div class="row g-2">
      <div class="col-auto">
        <button class="btn btn-outline-dark" @click="goBackPage">이전글</button>
      </div>
      <div class="col-auto">
...
const goBackPage = () => router.push(`/posts/${+idRef.value - 1}`);
const goNextPage = () => router.push(`/posts/${+idRef.value + 1}`);
